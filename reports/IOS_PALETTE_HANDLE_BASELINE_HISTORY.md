# Historical iOS Palette-Handle Playtest Baseline

Archived when ios-88 became the current baseline. References to "current" below describe the earlier import-based build, not the latest release.
