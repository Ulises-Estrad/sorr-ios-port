...
- Current: final playtest controls. The app has the `Streets of Rage` display name, app icon, virtual joystick, pillar-safe CFG button, right-side Start/Back buttons, persistent custom layout settings, and visible crash reports. The current IPA is available from GitHub Actions run `26619778077`.
